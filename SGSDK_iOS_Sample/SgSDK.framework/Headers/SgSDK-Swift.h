...
+ (SGSDK * _Nonnull)Instance SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
- (void)CloseWebView;
- (void)InitWithGameKey:(NSString * _Nonnull)GameKey AppSecret:(NSString * _Nonnull)AppSecret;
- (void)Login;
- (void)Signup;
- (void)ForgotPassword;
- (void)ChangePassword;
...
- (void)MyAccount;
- (void)OpenID;
- (void)VerifySessionWithGameKey:(NSString * _Nonnull)gameKey sessionId:(NSString * _Nonnull)sessionId openId:(NSString * _Nonnull)openId sign:(NSString * _Nonnull)sign;
- (void)LoginByTokenWithToken:(NSString * _Nonnull)token;
- (void)Logout;
- (void)GameStart;
- (void)GameStop;
- (NSString * _Nullable)GetOpenID SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nullable)GetSessionID SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nullable)GetToken SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nullable)GetKidFace SWIFT_WARN_UNUSED_RESULT;
- (BOOL)IsLogin SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)GetChannelID SWIFT_WARN_UNUSED_RESULT;
- (void)HideWidget;
- (BOOL)IsWidgetVisible SWIFT_WARN_UNUSED_RESULT;
- (void)Destroy;
...
@interface UIApplication (SWIFT_EXTENSION(SGSDK))
@end


@interface UIButton (SWIFT_EXTENSION(SGSDK))
@end
